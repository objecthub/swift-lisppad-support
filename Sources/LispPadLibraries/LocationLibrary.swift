...
//  LispPadLibraries
//
//  Created by Matthias Zenger on 20/08/2021.
...
fileprivate final class LocationManager: NSObject, CLLocationManagerDelegate {
  ...
  var currentLocation: CLLocation? {
    ...
    while self.lastLocation == nil &&
      ...
      var deadline = Date()
      deadline.addTimeInterval(0.5)
      self.condition.wait(until: deadline)
